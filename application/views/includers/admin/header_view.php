...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo base_url('libs/admin');?>/css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?php echo base_url('libs/admin');?>/css/plugins/morris.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <?php foreach($navtop as $itensnav): ?>
                    <li>
                       <?php echo $itensnav; ?>
                    </li>
                    <?php endforeach; ?>
        ...
        $(function(){
           $('.logout').on('click',function(){
               var dados = '<?php echo $user_dados['0']->id; ?>'; 
